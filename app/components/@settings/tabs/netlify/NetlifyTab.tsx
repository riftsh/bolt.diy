          ...
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-wisp-elements-background dark:bg-wisp-elements-background-depth-2 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor hover:border-wisp-elements-borderColorActive/70 dark:hover:border-wisp-elements-borderColorActive/70 transition-all duration-200 cursor-pointer">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                <span className="text-sm font-medium text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              ...
              <div className="mb-6 p-4 bg-wisp-elements-background-depth-1 rounded-lg border border-wisp-elements-borderColor">
                <h4 className="text-sm font-medium text-wisp-elements-textPrimary mb-3">Netlify Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                      {connection.stats.totalSites}
                    </div>
                    <div className="text-xs text-wisp-elements-textSecondary">Total Sites</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                      {connection.stats.totalDeploys || deploymentCount}
                    </div>
                    <div className="text-xs text-wisp-elements-textSecondary">Total Deployments</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                      {connection.stats.totalBuilds || 0}
                    </div>
                    <div className="text-xs text-wisp-elements-textSecondary">Total Builds</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                      {sites.filter((site) => site.published_deploy?.state === 'ready').length}
                    </div>
                    <div className="text-xs text-wisp-elements-textSecondary">Live Sites</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 space-y-4">
                <h4 className="text-sm font-medium text-wisp-elements-textPrimary">Deployment Analytics</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-wisp-elements-background-depth-2 p-3 rounded-lg border border-wisp-elements-borderColor">
                    <h6 className="text-xs font-medium text-wisp-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:chart-pie w-4 h-4 text-wisp-elements-item-contentAccent" />
                      Success Rate
                    </h6>
                  ...
                  <div className="bg-wisp-elements-background-depth-2 p-3 rounded-lg border border-wisp-elements-borderColor">
                    <h6 className="text-xs font-medium text-wisp-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:clock w-4 h-4 text-wisp-elements-item-contentAccent" />
                      Recent Activity
                    </h6>
                    <div className="space-y-1">
                      {(() => {
              ...
              {/* Site Health Metrics */}
              <div className="mb-6">
                <h4 className="text-sm font-medium text-wisp-elements-textPrimary mb-2">Site Health Overview</h4>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary"
                >
                  <div className="i-ph:buildings w-4 h-4 text-wisp-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary"
                >
                  <div className="i-ph:rocket-launch w-4 h-4 text-wisp-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary"
                >
                  <div className="i-ph:hammer w-4 h-4 text-wisp-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-wisp-elements-background dark:bg-wisp-elements-background-depth-1 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary">
                          <div className="i-ph:buildings w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                          Your Sites ({sites.length})
                        </h4>
                        {sites.length > 8 && (
                          <button
                            onClick={() => setIsSitesExpanded(!isSitesExpanded)}
                            className="text-xs text-wisp-elements-textSecondary hover:text-wisp-elements-textPrimary transition-colors"
                          >
                      ...
                      <Button
                        ...
                        className="flex items-center gap-2 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary hover:bg-wisp-elements-item-backgroundActive/10"
                      >
                        <div
                          className={cn(
                            'i-ph:arrows-clockwise w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {(isSitesExpanded ? sites : sites.slice(0, 8)).map((site, index) => (
                        <div
                          key={site.id}
                          className={cn(
                            'bg-wisp-elements-background dark:bg-wisp-elements-background-depth-1 border rounded-lg p-4 transition-all cursor-pointer',
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="i-ph:cloud w-5 h-5 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                              <span className="font-medium text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary">
                          ...
                          <div className="mt-3 space-y-2">
                            <div className="flex items-center gap-2">
                              <a
                                ...
                                className="text-sm flex items-center gap-1 transition-colors text-wisp-elements-link-text hover:text-wisp-elements-link-textHover dark:text-white dark:hover:text-wisp-elements-link-textHover"
                                onClick={(e) => e.stopPropagation()}
                              >
                                <div className="i-ph:cloud w-3 h-3 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-4 text-xs text-wisp-elements-textSecondary">
                              {site.published_deploy?.framework && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:cube w-3 h-3 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                  <span>{site.published_deploy.framework}</span>
                                </div>
                              )}
                              {site.custom_domain && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:globe w-3 h-3 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                  <span>Custom Domain</span>
                                </div>
                              )}
                              {site.branch && (
                                <div className="flex items-center gap-1">
                                  <div className="i-ph:code w-3 h-3 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-wisp-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    ...
                                    >
                                      <div
                                        className={`${action.icon} w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent`}
                                      />
                                      {action.name}
                                    </Button>
                                  ))}
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <div className="i-ph:clock w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                    <span className="text-wisp-elements-textSecondary dark:text-wisp-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <div className="i-ph:code w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                      <span className="text-wisp-elements-textSecondary dark:text-wisp-elements-textSecondary">
                    ...
                    <div className="bg-wisp-elements-background dark:bg-wisp-elements-background-depth-1 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {(isDeploysExpanded ? deploys : deploys.slice(0, 10)).map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-wisp-elements-background dark:bg-wisp-elements-background-depth-1 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-wisp-elements-textSecondary dark:text-wisp-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-wisp-elements-textSecondary dark:text-wisp-elements-textSecondary flex items-center gap-1">
                                <div className="i-ph:code w-3 h-3 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                <span className="text-wisp-elements-textSecondary dark:text-wisp-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-wisp-elements-link-text hover:text-wisp-elements-link-textHover dark:text-white dark:hover:text-wisp-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <div className="i-ph:cloud w-3 h-3 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary"
                                >
                                  <div className="i-ph:lock w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary"
                                >
                                  <div className="i-ph:lock-open w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                  ...
                  {connection.stats.builds && connection.stats.builds.length > 0 && (
                    <div className="bg-wisp-elements-background dark:bg-wisp-elements-background-depth-1 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="text-sm font-medium flex items-center gap-2 text-wisp-elements-textPrimary dark:text-wisp-elements-textPrimary">
                          <div className="i-ph:hammer w-4 h-4 text-wisp-elements-item-contentAccent dark:text-wisp-elements-item-contentAccent" />
        ...
        <div className="p-6">
          {!connection.user ? (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-wisp-elements-textSecondary dark:text-wisp-elements-textSecondary mb-2">
                  API Token
                </label>
                <input
                  type="password"
