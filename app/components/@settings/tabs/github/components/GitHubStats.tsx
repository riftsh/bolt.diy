...
function GitHubStatsContent({
  ...
  if (!stats) {
    return (
      <div className="mt-6 border-t border-wisp-elements-borderColor dark:border-wisp-elements-borderColor pt-6">
        <div className="flex items-center justify-center p-8">
          <div className="flex items-center gap-2">
            {isLoading ? (
              <>
                <div className="i-ph:spinner-gap-bold animate-spin w-4 h-4" />
                <span className="text-wisp-elements-textSecondary">Loading GitHub stats...</span>
              </>
            ) : (
              <span className="text-wisp-elements-textSecondary">No stats available</span>
            )}
          </div>
        </div>
      </div>
      ...
      <Collapsible open={isExpanded} onOpenChange={onToggleExpanded}>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg bg-wisp-elements-background dark:bg-wisp-elements-background-depth-2 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor hover:border-wisp-elements-borderColorActive/70 dark:hover:border-wisp-elements-borderColorActive/70 transition-all duration-200">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-wisp-elements-textPrimary">
                GitHub Stats
                {isStale && <span className="text-wisp-elements-textTertiary ml-1">(Stale)</span>}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Button
        ...
        <CollapsibleContent className="overflow-hidden">
          <div className="space-y-4 mt-4">
            {/* Languages Section */}
            <div className="mb-6">
              <h4 className="text-sm font-medium text-wisp-elements-textPrimary mb-3">Top Languages</h4>
                ...
                <div className="space-y-3">
                  <div className="flex flex-wrap gap-2">
                    {stats.mostUsedLanguages.slice(0, 15).map(({ language, bytes, repos }) => (
                      <span
                        key={language}
                        className="px-3 py-1 text-xs rounded-full bg-wisp-elements-sidebar-buttonBackgroundDefault text-wisp-elements-sidebar-buttonText"
                  ...
                  <div className="text-xs text-wisp-elements-textSecondary">
            ...
            <div className="mb-6 p-4 bg-wisp-elements-background-depth-1 rounded-lg border border-wisp-elements-borderColor">
              <h4 className="text-sm font-medium text-wisp-elements-textPrimary mb-3">GitHub Overview</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                    {(stats.publicRepos || 0) + (stats.privateRepos || 0)}
                  </div>
                  <div className="text-xs text-wisp-elements-textSecondary">Total Repositories</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-wisp-elements-textPrimary">{stats.totalBranches || 0}</div>
                  <div className="text-xs text-wisp-elements-textSecondary">Total Branches</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                    {stats.organizations?.length || 0}
                  </div>
                  <div className="text-xs text-wisp-elements-textSecondary">Organizations</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-wisp-elements-textPrimary">
                    {Object.keys(stats.languages).length}
                  </div>
                  <div className="text-xs text-wisp-elements-textSecondary">Languages Used</div>
                </div>
              </div>
            </div>
            ...
            {/* Activity Summary */}
            <div className="mb-6">
              <h5 className="text-sm font-medium text-wisp-elements-textPrimary mb-2">Activity Summary</h5>
              <div className="grid grid-cols-4 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    iconColor: 'text-wisp-elements-icon-accent',
                  },
                ].map((stat, index) => (
                  <div
                    key={index}
                    className="flex flex-col p-3 rounded-lg bg-wisp-elements-background-depth-2 dark:bg-wisp-elements-background-depth-2 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor"
                  >
            ...
            {stats.organizations && stats.organizations.length > 0 && (
              <div>
                <h5 className="text-sm font-medium text-wisp-elements-textPrimary mb-2">Organizations</h5>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {stats.organizations.map((org) => (
                    <a
                      ...
                      className="flex items-center gap-3 p-3 rounded-lg bg-wisp-elements-background-depth-2 dark:bg-wisp-elements-background-depth-2 border border-wisp-elements-borderColor dark:border-wisp-elements-borderColor hover:border-wisp-elements-borderColorActive dark:hover:border-wisp-elements-borderColorActive transition-all duration-200"
                    >
                      <img
                        loading="lazy"
                        src={org.avatar_url}
                        alt={org.login}
                        className="w-8 h-8 rounded-full border border-wisp-elements-borderColor"
                      />
                      <div className="flex-1 min-w-0">
                        <h6 className="text-sm font-medium text-wisp-elements-textPrimary truncate">
                          {org.name || org.login}
                        </h6>
                        <p className="text-xs text-wisp-elements-textSecondary truncate">{org.login}</p>
                        {org.description && (
                          <p className="text-xs text-wisp-elements-textTertiary truncate">{org.description}</p>
                        )}
                      </div>
