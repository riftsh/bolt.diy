      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={cn(feature.icon, 'w-5 h-5 text-wisp-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-wisp-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-wisp-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-wisp-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={cn(icon, 'text-xl text-wisp-elements-item-contentAccent')} />
        <div>
          <h3 className="text-lg font-medium text-wisp-elements-textPrimary">{title}</h3>
          <p className="text-sm text-wisp-elements-textSecondary">{description}</p>
        </div>
      </div>
          ...
          <div className="flex items-center gap-4">
            <div
              className={cn(
                ...
                'bg-wisp-elements-background-depth-3 group-hover:bg-wisp-elements-background-depth-4',
                'transition-colors duration-200',
            ...
            <div className="flex-1">
              <h4 className="text-sm font-medium text-wisp-elements-textPrimary group-hover:text-wisp-elements-item-contentAccent transition-colors">
                Prompt Library
              </h4>
              <p className="text-xs text-wisp-elements-textSecondary mt-0.5">
            ...
            <select
              ...
              className={cn(
                ...
                'bg-wisp-elements-background-depth-3 border border-wisp-elements-borderColor',
                'text-wisp-elements-textPrimary',
                'focus:outline-none focus:ring-2 focus:ring-wisp-elements-borderColorActive',
                'group-hover:border-wisp-elements-borderColorActive/30',
                'transition-all duration-200',
              )}
            >
