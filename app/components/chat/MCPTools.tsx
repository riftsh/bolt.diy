      ...
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            ...
            <div className="i-wisp:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-wisp-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-wisp-elements-icon-error">{error}</p>}</div>
              </div>
