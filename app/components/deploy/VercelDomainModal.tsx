          ...
          <RadixDialog.Portal>
            ...
            <RadixDialog.Content asChild>
              <motion.div
                ...
                style={{
                  backgroundColor: 'var(--wisp-elements-bg-depth-3)',
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <RadixDialog.Title
                        ...
                        style={{ color: 'var(--wisp-elements-textPrimary)' }}
                      >
                        Domain Settings
                      </RadixDialog.Title>
                      <RadixDialog.Description
                        className="text-sm"
                        style={{ color: 'var(--wisp-elements-textSecondary)' }}
                      >
                ...
                <div className="p-6 space-y-6">
                  <div>
                    <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--wisp-elements-textPrimary)' }}>
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundColor: 'var(--wisp-elements-bg-depth-2)',
                          border: '1px solid var(--wisp-elements-borderColor)',
                        }}
                      >
                        <input
                        ...
                        style={{
                          backgroundColor:
                            isSaving || !newSubdomain.trim()
                              ? 'var(--wisp-elements-bg-depth-3)'
                              : 'var(--wisp-elements-bg-depth-4)',
                          color:
                            isSaving || !newSubdomain.trim()
                              ? 'var(--wisp-elements-textTertiary)'
                              : 'var(--wisp-elements-textPrimary)',
                          border: '1px solid var(--wisp-elements-borderColor)',
                    ...
                    <p className="mt-2 text-xs" style={{ color: 'var(--wisp-elements-textTertiary)' }}>
                  ...
                  {error && (
                    <div
                      ...
                      style={{
                        backgroundColor: 'var(--wisp-elements-button-danger-background)',
                        border: '1px solid var(--wisp-elements-button-danger-backgroundHover)',
                      }}
                    >
                      <div className="i-ph:warning-circle text-red-400 w-5 h-5 flex-shrink-0" />
                      <span style={{ color: 'var(--wisp-elements-button-danger-text)' }}>{error}</span>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    {isLoading ? (
                      <div
                        ...
                        style={{ backgroundColor: 'var(--wisp-elements-bg-depth-2)' }}
                      >
                        <div
                        ...
                        {domains.map((domain) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              />
                              <span className="text-sm" style={{ color: 'var(--wisp-elements-textPrimary)' }}>
                                {domain.name}
                              </span>
                              {domain.verified && (
                                <span
                            ...
                            <div className="flex items-center gap-2">
                              <a
                                ...
                                className="p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity hover:bg-wisp-elements-bg-depth-3"
                                style={{ color: 'var(--wisp-elements-textSecondary)' }}
                              >
                              ...
                              <button
                                ...
                                style={{ color: 'var(--wisp-elements-button-danger-text)' }}
                              >
                  ...
                  {currentUrl && (
                    <div className="pt-4" style={{ borderTop: '1px solid var(--wisp-elements-borderColor)' }}>
                      <h3 className="text-sm font-medium mb-2" style={{ color: 'var(--wisp-elements-textPrimary)' }}>
                        Current Deployment
                      </h3>
                      <a
                        href={currentUrl}
                        ...
                        style={{ color: 'var(--wisp-elements-messages-linkColor)' }}
                      >
                ...
                >
                  <button
                    ...
                    style={{
                      backgroundColor: 'var(--wisp-elements-bg-depth-3)',
                      color: 'var(--wisp-elements-textPrimary)',
                      border: '1px solid var(--wisp-elements-borderColor)',
                    }}
                  >
                    Close
