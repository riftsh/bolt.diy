            ...
            >
              <div
                className={cn(
                  'text-xl',
                  type === 'success'
                    ? 'i-ph:check-circle-duotone text-wisp-elements-icon-success'
                    : type === 'error'
                      ? 'i-ph:warning-duotone text-wisp-elements-button-danger-text'
                      : 'i-ph:info-duotone text-wisp-elements-loader-progress',
                )}
              ></div>
            </motion.div>
            {/* Content */}
                      ...
                      <div className="flex items-center">
                        <div
                          className={cn(
                            ...
                            buildStatus === 'running'
                              ? 'bg-wisp-elements-loader-progress'
                              : buildStatus === 'complete'
                                ? 'bg-wisp-elements-icon-success'
                                : buildStatus === 'failed'
                                  ? 'bg-wisp-elements-button-danger-background'
                                  : 'bg-wisp-elements-textTertiary',
                          )}
                        >
                          {buildStatus === 'running' ? (
                ...
                {url && type === 'success' && (
                  <div className="mt-3 space-y-2">
                    <a
                      ...
                      className="text-wisp-elements-item-contentAccent hover:underline flex items-center"
                    >
                    ...
                    {isVercelSuccess && (
                      <button
                        ...
                        className={cn(
                          ...
                          'hover:bg-wisp-elements-background-depth-4 hover:border-accent-500/50',
                          'transition-all',
                        )}
                      >
